...
public partial class MetaContext {
    ...
    public MetaEntity SetInputService(src.libs.src.services.core.input.service.IInputService newService) {
        if (hasInputService) {
            throw new Entitas.EntitasException("Could not set InputService!\n" + this + " already has an entity with src.libs.src.components.meta.InputServiceComponent!",
    ...
    public void ReplaceInputService(src.libs.src.services.core.input.service.IInputService newService) {
...
public partial class MetaEntity {
    ...
    public void AddInputService(src.libs.src.services.core.input.service.IInputService newService) {
