...
public partial class MetaContext {
    ...
    public MetaEntity SetTimeService(src.libs.src.services.core.time.ITimeService newTime) {
        if (hasTimeService) {
            throw new Entitas.EntitasException("Could not set TimeService!\n" + this + " already has an entity with src.libs.src.components.meta.TimeServiceComponent!",
    ...
    public void ReplaceTimeService(src.libs.src.services.core.time.ITimeService newTime) {
...
public partial class MetaEntity {
    ...
    public void AddTimeService(src.libs.src.services.core.time.ITimeService newTime) {
